...
class Sym5(SymGroup):
    def __init__(self):
        ...
        subgroups = self.list_subgroups()
        subgroups_flat = {}
        for key, value in subgroups:
            subgroups_flat[key] = [subgroup._elements for subgroup in value]
...
sym5 = Sym5()
auto_classes = sym5.list_automorphism_class_of_subgroups()
sub_groups = sym5.list_subgroups()
print(sub_groups)